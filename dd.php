...
<html>
    ...
    <body style="background-color: #D4E7C5;">
        <div style="height:900px; width:100%; display:flex; flex-direction:row;">
            <div class="container" style="background-color: #D4E7C5; width: 1100px; padding:40px;">
                <form action="up_dd.php" method="post">
                </br></br></br></br>
                ...
                <input type="text" name="l_name" class="form-control" placeholder="Enter your Last name">
                </br></br></br>
                </div>
            ...
            <div>
            <div style="background-color: #99BC85; width:430px; height:100%; padding: 30px; padding-top:10px; border-radius:15%;">
